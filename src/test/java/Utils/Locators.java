...
public abstract class Locators extends BasePage {
    ...
    //Workflow 3
    @FindBy(xpath = "//p[contains(text(),'Material Group (H)')]//..//..//div//input")
    protected WebElement externalMaterialGroupInputField;
    @FindBy(xpath = "//p[normalize-space()='Base Unit of Measure']//..//..//div//input")
    protected WebElement baseUnitOfMeasureInputFiled;
    @FindBy(xpath = "//p[contains(text(),'MRP Type')]//..//..//div//input")
    protected WebElement mrpInputTypeInputField;
    @FindBy(xpath = "//p[normalize-space()='Unit of Weight']//..//..//div//input")
    protected WebElement unitOfWeightFieldInputField;
    @FindBy(xpath = "//p[normalize-space()='Availibility Check']//..//..//div//input")
    protected WebElement availabilityCheckInputField;
    @FindBy(xpath = "//p[normalize-space()='MRP Controller']//..//..//div//input")
    protected WebElement mrpControllerInputField;
    @FindBy(xpath = "//p[normalize-space()='Profit Center']//..//..//div//input")
    protected WebElement profitCenterInputField;
    @FindBy(xpath = "//p[normalize-space()='1st Rem./Exped.']//..//..//..//div//input")
    protected WebElement remExped1InputField;
    @FindBy(xpath = "//p[normalize-space()='2nd Rem./Exped.']//..//..//..//div//input")
    protected WebElement remExped2InputField;
    @FindBy(xpath = "//p[normalize-space()='3rd Rem./Exped.']//..//..//..//div//input")
    protected WebElement remExped3InputField;
    @FindBy(xpath = "//p[contains(text(),'Forecast model:')]")
    protected WebElement forecastModel0001M1;
    @FindBy(xpath = "//p[contains(text(),'Storage Location')]")
