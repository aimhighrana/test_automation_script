...
public class TransformationRuleTestcases extends BasePage {
	...
	public void verify_Transformation_Rule_Of_Type_EMPTY_SPACE_With_Remove_Leading_Spaces_On_Transaction_Page(String env) throws InterruptedException, IOException, Exception {
		common.log("TC:MDMF-TC-6808");
		common.log("Pre condition: Transformation Rule must be configured with remove leading spaces option for Material description field");
	...
	public void verify_Transformation_Rule_Of_Type_EMPTY_SPACE_With_Remove_Trailing_Spaces_On_Transaction_Page(String env) throws InterruptedException, IOException, Exception {
		common.log("TC:MDMF-TC-6809");
		common.log("Pre condition: Transformation Rule must be configured with remove trailing spaces option for Material description field");
		common.log("Rule for QAH - Material creation process / SANDBOX - SequentialMaterial");
		loginPage.goToURL(env);
		loginPage.check_SignIn(env);
	...
	public void verify_Transformation_Rule_Of_Type_EMPTY_SPACE_With_Remove_All_Spaces_On_Transaction_Page(String env) throws InterruptedException, IOException, Exception {
		common.log("TC:MDMF-TC-6810");
		common.log("Pre condition: Transformation Rule must be configured with remove all spaces option for Material description field");
		common.log("Rule for QAH - Material creation process / SANDBOX - SequentialMaterial");
		loginPage.goToURL(env);
		loginPage.check_SignIn(env);
	...
	public void verify_Transformation_Rule_Of_Type_Concatenation_With_Separation_Value_On_Transaction_Page(String env) throws InterruptedException, IOException, Exception {
		common.log("TC:MDMF-TC-6864");
		common.log("Pre condition: Transformation Rule must be configured with Type of Concatenation with Separation option: field1: Material description, field2: Gross weight, Target Field: Volume");
		common.log("Rule for QAH - Material creation process / SANDBOX - SequentialMaterial");
		loginPage.goToURL(env);
		loginPage.check_SignIn(env);
