...
public class AddMaterialMaster extends Locators {
    ...
    public void goToMaterialMasterSection() throws Exception {
     ...
     */
    public void addNewMaterialMaster() throws Exception {

        XSSFSheet sheet = common.getDataFromExcelSheet("Workflow_1_TestCases");

        goToMaterialMasterSection();
...
//		common.findElement(manufacturerHersGrid).sendKeys(manufacturerHersGridValue);
     ...
     */
    public void createMaterialMasterWithGenerateDesc() throws Exception {
     ...
     */
    public void viewMaterialMasterProcessLog() throws Exception {
     ...
     */
    public void viewMaterialMasterCompletedProcessLog() throws Exception {
    ...
    public void verify_Copy_Record_And_Remove_One_Hierarchy_Other_Should_Not_Remove() throws Exception {
        goToMaterialMasterSection();
        String mmN = common.findElement(materialMasterNum).getText();
        common.log("Material master number is : " + mmN);
    ...
    /**
     * Add New Material Master Record and verifying Default Values for A WorkFlow 3
     */
    public void verifyDefaultValuesOnSequentialFlow() throws Exception {

        XSSFSheet sheet = common.getDataFromExcelSheet("Workflow_3_TestCases");
        goToMaterialMasterSection();
        common.waitUntilElementToBeVisible(newRecordBtn);
        common.log("Click on add new record button");
        ...
        if (common.isElementDisplayed(sequentialMaterialOption)) {
            ...
            common.waitUntilElementToBeVisible(baseUnitOfMeasureInputFiled);
            String actualBaseUnitMeasureValue = common.findElement(baseUnitOfMeasureInputFiled).getAttribute("value");
            common.log("Get Base Unit of Measure from Excel: " + sheet.getRow(1).getCell(0));
            String expectedBaseUnitMeasureValue = String.valueOf(sheet.getRow(1).getCell(0));
            common.log("Verified Default Base Unit of Measure");
            soft.assertEquals(actualBaseUnitMeasureValue, expectedBaseUnitMeasureValue, "Base Unit Of Measure value mismatched");

            common.waitUntilElementToBeVisible(volumeUnitField);
            String actualVolumeUnitValue = common.findElement(volumeUnitField).getAttribute("value");
            common.log("Get Volume Unit from Excel: " + sheet.getRow(1).getCell(1));
            String expectedVolumeUnitValue = String.valueOf(sheet.getRow(1).getCell(1));
            common.log("Verified Default Volume Unit");
            soft.assertEquals(actualVolumeUnitValue, expectedVolumeUnitValue, "Volume Unit value mismatched");

            common.waitUntilElementToBeVisible(externalMaterialGroupInputField);
            String actualExternalMaterialGroupValue = common.findElement(externalMaterialGroupInputField).getAttribute("value");
            common.log("Get External Material Group(H) from Excel: " + sheet.getRow(1).getCell(2));
            String expectedExternalMaterialGroupValue = String.valueOf(sheet.getRow(1).getCell(2));
            common.log("Verified Default External Material Group(H)");
            soft.assertEquals(actualExternalMaterialGroupValue, expectedExternalMaterialGroupValue, "External Material Group(H) value mismatched");

            common.waitUntilElementToBeVisible(unitOfWeightFieldInputField);
            String actualUnitOfWeightValue = common.findElement(unitOfWeightFieldInputField).getAttribute("value");
            common.log("Get Unit Of Weight from Excel: " + sheet.getRow(1).getCell(3));
            String expectedUnitOfWeightValue = String.valueOf(sheet.getRow(1).getCell(3));
            common.log("Verified Default Unit Of Weight");
            soft.assertEquals(actualUnitOfWeightValue, expectedUnitOfWeightValue, "Unit of Weight value mismatched");

            common.waitUntilElementToBeVisible(plantData0001);
            String plantValue = common.findElement(plantData0001).getText();
            String actualPlantValue = plantValue.substring(6);
            common.log("Get Plant value from Excel: " + sheet.getRow(1).getCell(4));
            String expectedPlantValue = String.valueOf(sheet.getRow(1).getCell(4));
            common.log("Verified Default Plant value");
            soft.assertEquals(actualPlantValue, expectedPlantValue, "Plant value mismatched");

            common.waitUntilElementToBeVisible(mrpInputTypeInputField);
            String actualMRPInputValue = common.findElement(mrpInputTypeInputField).getAttribute("value");
            common.log("Get MRP Type from Excel: " + sheet.getRow(1).getCell(5));
            String expectedMRPInputValue = String.valueOf(sheet.getRow(1).getCell(5));
            common.log("Verified Default MRP Type");
            soft.assertEquals(actualMRPInputValue, expectedMRPInputValue, "MRP type value mismatched");

            common.waitUntilElementToBeVisible(availabilityCheckInputField);
            String actualAvailabilityCheckValue = common.findElement(availabilityCheckInputField).getAttribute("value");
            common.log("Get Availability Check from Excel: " + sheet.getRow(1).getCell(6));
            String expectedAvailabilityCheckValue = String.valueOf(sheet.getRow(1).getCell(6));
            common.log("Verified Default Availability Check");
            soft.assertEquals(actualAvailabilityCheckValue, expectedAvailabilityCheckValue, "Availability Check value mismatched");

            common.waitUntilElementToBeVisible(mrpControllerInputField);
            String actualMRPControllerValue = common.findElement(mrpControllerInputField).getAttribute("value");
            common.log("Get MRP Controller from Excel: " + sheet.getRow(1).getCell(7));
            String expectedMRPControllerValue = String.valueOf(sheet.getRow(1).getCell(7));
            common.log("Verified Default MRP Controller");
            soft.assertEquals(actualMRPControllerValue, expectedMRPControllerValue, "MRP Controller value mismatched");

            common.waitUntilElementToBeVisible(profitCenterInputField);
            String actualProfitCenterValue = common.findElement(profitCenterInputField).getAttribute("value");
            common.log("Get Profit Center from Excel: " + sheet.getRow(1).getCell(8));
            String expectedProfitCenterValue = String.valueOf(sheet.getRow(1).getCell(8));
            common.log("Verified Default Profit Center");
            soft.assertEquals(actualProfitCenterValue, expectedProfitCenterValue, " Profit Center value mismatched");

            common.waitUntilElementToBeVisible(remExped1InputField);
            String actual1stRemExpedValue = common.findElement(remExped1InputField).getAttribute("value");
            common.log("Get 1st Rem./Exped. from Excel: " + sheet.getRow(1).getCell(9));
            String expected1stRemExpedValue = String.valueOf(sheet.getRow(1).getCell(9));
            common.log("Verified Default 1st Rem./Exped.");
            soft.assertEquals(actual1stRemExpedValue, expected1stRemExpedValue, "1st Rem./Exped. value mismatched");

            common.waitUntilElementToBeVisible(remExped2InputField);
            String actual2ndRemExpedValue = common.findElement(remExped2InputField).getAttribute("value");
            common.log("Get 2nd Rem./Exped. from Excel: " + sheet.getRow(1).getCell(10));
            String expected2ndRemExpedValue = String.valueOf(sheet.getRow(1).getCell(10));
            common.log("Verified Default 2nd Rem./Exped.");
...
//            soft.assertEquals(actual3rdRemExpedValue, expected3rdRemExpedValue, "3rd Rem./Exped. value mismatched");
            ...
            String actualForecastModelValue = forecastModelValue.substring(15);
            common.log("Get Forecast Model from Excel: " + sheet.getRow(1).getCell(12));
            String expectedForecastModelValue = String.valueOf(sheet.getRow(1).getCell(12));
            common.log("Verified Default Forecast Model");
...
//            soft.assertEquals(actualStorageLocationValue, expectedStorageLocationValue, "Storage Location value mismatched");
            ...
            String actualValuationTypeValue = valuationTypeValue.substring(15);
            common.log("Get Valuation Type from Excel: " + sheet.getRow(1).getCell(14));
            String expectedValuationTypenValue = String.valueOf(sheet.getRow(1).getCell(14));
            common.log("Verified Default Valuation Type");
            soft.assertEquals(actualValuationTypeValue, expectedValuationTypenValue, "Valuation Type value mismatched");
            ...
            common.findElement(materialType).click();
            common.waitUntilElementToBeVisible(dropValue);
            common.findElementBy(materialType,"Entering ERSA - Spare Part in Material Type").sendKeys("ERSA");
            common.pause(5);
            common.findElement(materialType).sendKeys(Keys.DOWN);
            common.findElement(materialType).sendKeys(Keys.ENTER);
            ...
            common.log("Enter value in Reorder Point field");
            common.findElement(reorderPointField).sendKeys("60");

            common.log("Enter value in Maximum Stock Level field");
            common.findElement(maxStockLevelField).sendKeys("65");
