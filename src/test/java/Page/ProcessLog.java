...
public class ProcessLog extends Locators {
    ...
    public void verify_View_Process_Log_Popup() throws Exception {
        common.pause(5);
        ...
        common.pause(10);
        common.waitUntilElementToBeVisible(materialMasterHeader);
     ...
     */
    public void verify_That_User_Is_Able_To_View_Email_Logs_In_Process_Log() throws Exception {
        verify_View_Process_Log_Popup();
     ...
     */
    public void verify_Tooltip_Is_Visible_For_Comment_Icon_In_Side_Sheet() throws Exception {
     ...
     */
    public void verify_Tooltip_Is_Visible_For_External_Icon_In_Sidesheet() throws Exception {
